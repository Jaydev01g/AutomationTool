          ...
          <div>
            ...
            <div className="mt-8 flex items-center space-x-4">
              <div className="flex -space-x-2">
                <div className="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center text-xs">TW</div>
                <div className="w-8 h-8 rounded-full bg-gray-300 flex items-center justify-center text-xs">JD</div>
                <div className="w-8 h-8 rounded-full bg-gray-400 flex items-center justify-center text-xs">AM</div>
              </div>
              <p className="text-sm text-gray-600">
                <span className="font-semibold">1,000+ teams</span> already using NextGen
              </p>
            </div>
          </div>
          <div>
      ...
      <section className="py-12 md:py-24 bg-gradient-to-r from-indigo-600 to-purple-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg md:text-xl max-w-2xl mx-auto">
            Join thousands of teams who have accelerated their development
            cycle with NextGen Automation.
          </p>
          <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Button variant="outline" className="border-white text-white hover:bg-white/10 p-6">
              Schedule Demo
            </Button>
          </div>
        </div>
